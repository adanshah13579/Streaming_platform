...
const dares = [
  { username: "JohnySilverBallz", amount: "$800", time: "", status: null },
...
const StreamDares = () => {
  return (
    ...
    >
      {/* Header */}
      <Typography sx={{ fontSize: "0.9rem", fontWeight: "500", mb: 1 }}>Stream Dares</Typography>
